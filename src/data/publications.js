...
export const publications = [
  {
    ...
    authors: [{ text: "X. Li, " }, { text: "S. Xu", strong: true }, { text: ", Z. Zhang, Z. Cai, Y. Chen, and G. Zhai" }],
    venue: "ACM MM '26",
    ccf: "CCF A",
  ...
  },
  {
    ...
    authors: [{ text: "X. Li, Z. Zhang, Z. Xu, " }, { text: "S. Xu", strong: true }, { text: ", X. Min, Y. Chen, and G. Zhai" }],
    venue: "Preprint '26",
    venueType: "preprint",
